...
def gen_anchor(featuresize, scale):
    ...
    """
    heights = [15, 20, 27, 37, 52, 72, 101, 143, 202, 287]
    # heights = [15, 21, 29, 41, 57, 80, 122, 158, 221, 309]
    # heights=[14,16,20,24,29,34,41,50,60,72,86,104,124,149,179,215,258,310]
