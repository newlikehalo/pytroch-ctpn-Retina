...
#define __PYX_HAVE__ctpn__lib__utils__cython_nms
#define __PYX_HAVE_API__ctpn__lib__utils__cython_nms
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'ctpn.lib.utils.cython_nms' */
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_4ctpn_3lib_5utils_10cython_nms_max(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_4ctpn_3lib_5utils_10cython_nms_min(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int_t = { "int_t", NULL, sizeof(__pyx_t_5numpy_int_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int_t), 0 };
#define __Pyx_MODULE_NAME "ctpn.lib.utils.cython_nms"
extern int __pyx_module_is_main_ctpn__lib__utils__cython_nms;
int __pyx_module_is_main_ctpn__lib__utils__cython_nms = 0;

/* Implementation of 'ctpn.lib.utils.cython_nms' */
...
static const char __pyx_k_ctpn_lib_utils_cython_nms[] = "ctpn.lib.utils.cython_nms";
...
static PyObject *__pyx_n_s_ctpn_lib_utils_cython_nms;
...
static PyObject *__pyx_pf_4ctpn_3lib_5utils_10cython_nms_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh); /* proto */
static PyObject *__pyx_pf_4ctpn_3lib_5utils_10cython_nms_2nms_new(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh); /* proto */
...
/* "ctpn/lib/utils/cython_nms.pyx":13
 * 
 * 
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_4ctpn_3lib_5utils_10cython_nms_max(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("max", 0);

  /* "ctpn/lib/utils/cython_nms.pyx":14
 * 
 * cdef inline np.float32_t max(np.float32_t a, np.float32_t b):
 *     return a if a >= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "ctpn/lib/utils/cython_nms.pyx":16
 *     return a if a >= b else b
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):             # <<<<<<<<<<<<<<
 *     return a if a <= b else b
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_4ctpn_3lib_5utils_10cython_nms_min(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("min", 0);

  /* "ctpn/lib/utils/cython_nms.pyx":17
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):
 *     return a if a <= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "ctpn/lib/utils/cython_nms.pyx":19
 *     return a if a <= b else b
 * 
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_4ctpn_3lib_5utils_10cython_nms_1nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4ctpn_3lib_5utils_10cython_nms_1nms = {"nms", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4ctpn_3lib_5utils_10cython_nms_1nms, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4ctpn_3lib_5utils_10cython_nms_1nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_thresh)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("nms", 1, 2, 2, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "nms") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("nms", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctpn.lib.utils.cython_nms.nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_4ctpn_3lib_5utils_10cython_nms_nms(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_4ctpn_3lib_5utils_10cython_nms_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh) {
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":20
 * 
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":21
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":22
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":23
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":24
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__6); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":26
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = PyNumber_Subtract(((PyObject *)__pyx_v_x2), ((PyObject *)__pyx_v_x1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_7 = __Pyx_PyInt_AddObjC(__pyx_t_1, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Subtract(((PyObject *)__pyx_v_y2), ((PyObject *)__pyx_v_y1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyInt_AddObjC(__pyx_t_1, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Multiply(__pyx_t_7, __pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":27
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_scores), __pyx_n_s_argsort); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_7 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_GetItem(__pyx_t_1, __pyx_slice__7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (!(likely(((__pyx_t_8) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_8, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 27, __pyx_L1_error)
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":29
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":31
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 *         np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_ndets); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  ...
  __pyx_t_12 = __Pyx_PyObject_GetAttrStr(__pyx_t_11, __pyx_n_s_int); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_dtype, __pyx_t_12) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __pyx_t_12 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_7, __pyx_t_8); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  if (!(likely(((__pyx_t_12) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_12, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 31, __pyx_L1_error)
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":44
 ...
 *         i = order[_i]
 */
  __pyx_t_12 = PyList_New(0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_v_keep = ((PyObject*)__pyx_t_12);
  __pyx_t_12 = 0;

  /* "ctpn/lib/utils/cython_nms.pyx":45
 * 
 *     keep = []
 *     for _i in range(ndets):             # <<<<<<<<<<<<<<
 *         i = order[_i]
 ...
 */
  ...
  for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":46
 *     keep = []
 *     for _i in range(ndets):
 *         i = order[_i]             # <<<<<<<<<<<<<<
 *         if suppressed[i] == 1:
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":47
 *     for _i in range(ndets):
 *         i = order[_i]
 *         if suppressed[i] == 1:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_20) {
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":48
 *         i = order[_i]
 *         if suppressed[i] == 1:
 *             continue             # <<<<<<<<<<<<<<
 *         keep.append(i)
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":49
 *         if suppressed[i] == 1:
 *             continue
 *         keep.append(i)             # <<<<<<<<<<<<<<
 *         ix1 = x1[i]
 *         iy1 = y1[i]
 */
    __pyx_t_12 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_21 = __Pyx_PyList_Append(__pyx_v_keep, __pyx_t_12); if (unlikely(__pyx_t_21 == ((int)-1))) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;

    /* "ctpn/lib/utils/cython_nms.pyx":50
 *             continue
 *         keep.append(i)
 *         ix1 = x1[i]             # <<<<<<<<<<<<<<
 *         iy1 = y1[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":51
 *         keep.append(i)
 *         ix1 = x1[i]
 *         iy1 = y1[i]             # <<<<<<<<<<<<<<
 *         ix2 = x2[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":52
 *         ix1 = x1[i]
 *         iy1 = y1[i]
 *         ix2 = x2[i]             # <<<<<<<<<<<<<<
 *         iy2 = y2[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":53
 *         iy1 = y1[i]
 *         ix2 = x2[i]
 *         iy2 = y2[i]             # <<<<<<<<<<<<<<
 *         iarea = areas[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":54
 *         ix2 = x2[i]
 *         iy2 = y2[i]
 *         iarea = areas[i]             # <<<<<<<<<<<<<<
 *         for _j in range(_i + 1, ndets):
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":55
 *         iy2 = y2[i]
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):             # <<<<<<<<<<<<<<
 *             j = order[_j]
 ...
 */
    ...
    for (__pyx_t_28 = (__pyx_v__i + 1); __pyx_t_28 < __pyx_t_27; __pyx_t_28+=1) {
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":56
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]             # <<<<<<<<<<<<<<
 *             if suppressed[j] == 1:
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":57
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]
 *             if suppressed[j] == 1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_20) {
        ...
        /* "ctpn/lib/utils/cython_nms.pyx":58
 *             j = order[_j]
 *             if suppressed[j] == 1:
 *                 continue             # <<<<<<<<<<<<<<
 *             xx1 = max(ix1, x1[j])
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":59
 *             if suppressed[j] == 1:
 *                 continue
 *             xx1 = max(ix1, x1[j])             # <<<<<<<<<<<<<<
 *             yy1 = max(iy1, y1[j])
 ...
 */
      ...
      __pyx_v_xx1 = __pyx_f_4ctpn_3lib_5utils_10cython_nms_max(__pyx_v_ix1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x1.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_x1.diminfo[0].strides)));

      /* "ctpn/lib/utils/cython_nms.pyx":60
 *                 continue
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])             # <<<<<<<<<<<<<<
 *             xx2 = min(ix2, x2[j])
 ...
 */
      ...
      __pyx_v_yy1 = __pyx_f_4ctpn_3lib_5utils_10cython_nms_max(__pyx_v_iy1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y1.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_y1.diminfo[0].strides)));

      /* "ctpn/lib/utils/cython_nms.pyx":61
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])             # <<<<<<<<<<<<<<
 *             yy2 = min(iy2, y2[j])
 ...
 */
      ...
      __pyx_v_xx2 = __pyx_f_4ctpn_3lib_5utils_10cython_nms_min(__pyx_v_ix2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x2.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_x2.diminfo[0].strides)));

      /* "ctpn/lib/utils/cython_nms.pyx":62
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])             # <<<<<<<<<<<<<<
 *             w = max(0.0, xx2 - xx1 + 1)
 ...
 */
      ...
      __pyx_v_yy2 = __pyx_f_4ctpn_3lib_5utils_10cython_nms_min(__pyx_v_iy2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y2.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_y2.diminfo[0].strides)));

      /* "ctpn/lib/utils/cython_nms.pyx":63
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)             # <<<<<<<<<<<<<<
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 */
      __pyx_v_w = __pyx_f_4ctpn_3lib_5utils_10cython_nms_max(0.0, ((__pyx_v_xx2 - __pyx_v_xx1) + 1.0));

      /* "ctpn/lib/utils/cython_nms.pyx":64
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)             # <<<<<<<<<<<<<<
 *             inter = w * h
 ...
 */
      __pyx_v_h = __pyx_f_4ctpn_3lib_5utils_10cython_nms_max(0.0, ((__pyx_v_yy2 - __pyx_v_yy1) + 1.0));

      /* "ctpn/lib/utils/cython_nms.pyx":65
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h             # <<<<<<<<<<<<<<
 *             ovr = inter / (iarea + areas[j] - inter)
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":66
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)             # <<<<<<<<<<<<<<
 *             if ovr >= thresh:
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":67
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)
 *             if ovr >= thresh:             # <<<<<<<<<<<<<<
 *                 suppressed[j] = 1
 * 
 */
      __pyx_t_12 = PyFloat_FromDouble(__pyx_v_ovr); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 67, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __pyx_t_8 = PyObject_RichCompare(__pyx_t_12, __pyx_v_thresh, Py_GE); __Pyx_XGOTREF(__pyx_t_8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 67, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_t_8); if (unlikely(__pyx_t_20 < 0)) __PYX_ERR(0, 67, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      if (__pyx_t_20) {

        /* "ctpn/lib/utils/cython_nms.pyx":68
 *             ovr = inter / (iarea + areas[j] - inter)
 *             if ovr >= thresh:
 *                 suppressed[j] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":70
 *                 suppressed[j] = 1
 * 
 *     return keep             # <<<<<<<<<<<<<<
 * 
...
/* "ctpn/lib/utils/cython_nms.pyx":72
 *     return keep
 * 
 * def nms_new(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
...
/* Python wrapper */
static PyObject *__pyx_pw_4ctpn_3lib_5utils_10cython_nms_3nms_new(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4ctpn_3lib_5utils_10cython_nms_3nms_new = {"nms_new", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4ctpn_3lib_5utils_10cython_nms_3nms_new, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4ctpn_3lib_5utils_10cython_nms_3nms_new(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_dets = 0;
  PyObject *__pyx_v_thresh = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_thresh)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("nms_new", 1, 2, 2, 1); __PYX_ERR(0, 72, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "nms_new") < 0)) __PYX_ERR(0, 72, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("nms_new", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 72, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctpn.lib.utils.cython_nms.nms_new", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dets), __pyx_ptype_5numpy_ndarray, 1, "dets", 0))) __PYX_ERR(0, 72, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_thresh), (&PyFloat_Type), 1, "thresh", 1))) __PYX_ERR(0, 72, __pyx_L1_error)
  __pyx_r = __pyx_pf_4ctpn_3lib_5utils_10cython_nms_2nms_new(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_4ctpn_3lib_5utils_10cython_nms_2nms_new(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh) {
  PyArrayObject *__pyx_v_x1 = 0;
  PyArrayObject *__pyx_v_y1 = 0;
  PyArrayObject *__pyx_v_x2 = 0;
  PyArrayObject *__pyx_v_y2 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dets.rcbuffer->pybuffer, (PyObject*)__pyx_v_dets, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 72, __pyx_L1_error)
  }
  __pyx_pybuffernd_dets.diminfo[0].strides = __pyx_pybuffernd_dets.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_dets.diminfo[0].shape = __pyx_pybuffernd_dets.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_dets.diminfo[1].strides = __pyx_pybuffernd_dets.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_dets.diminfo[1].shape = __pyx_pybuffernd_dets.rcbuffer->pybuffer.shape[1];

  /* "ctpn/lib/utils/cython_nms.pyx":73
 * 
 * def nms_new(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":74
 * def nms_new(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":75
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":76
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":77
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]             # <<<<<<<<<<<<<<
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__6); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":79
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 * 
 */
  __pyx_t_1 = PyNumber_Subtract(((PyObject *)__pyx_v_x2), ((PyObject *)__pyx_v_x1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_7 = __Pyx_PyInt_AddObjC(__pyx_t_1, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Subtract(((PyObject *)__pyx_v_y2), ((PyObject *)__pyx_v_y1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyInt_AddObjC(__pyx_t_1, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Multiply(__pyx_t_7, __pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":80
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 * 
 *     cdef int ndets = dets.shape[0]
 */
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_scores), __pyx_n_s_argsort); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_7 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
    __pyx_t_7 = PyMethod_GET_SELF(__pyx_t_8);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_GetItem(__pyx_t_1, __pyx_slice__7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":82
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 ...
 */
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":84
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 *         np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_ndets); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  ...
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_12 = __Pyx_PyObject_GetAttrStr(__pyx_t_11, __pyx_n_s_int); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_dtype, __pyx_t_12) < 0) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __pyx_t_12 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_7, __pyx_t_8); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  if (!(likely(((__pyx_t_12) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_12, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 84, __pyx_L1_error)
  __pyx_t_13 = ((PyArrayObject *)__pyx_t_12);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_suppressed.rcbuffer->pybuffer, (PyObject*)__pyx_t_13, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":97
 *     cdef np.float32_t inter, ovr
 * 
 *     keep = []             # <<<<<<<<<<<<<<
 *     for _i in range(ndets):
 *         i = order[_i]
 */
  __pyx_t_12 = PyList_New(0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_v_keep = ((PyObject*)__pyx_t_12);
  __pyx_t_12 = 0;

  /* "ctpn/lib/utils/cython_nms.pyx":98
 * 
 *     keep = []
 *     for _i in range(ndets):             # <<<<<<<<<<<<<<
 *         i = order[_i]
 ...
 */
  ...
  for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":99
 *     keep = []
 *     for _i in range(ndets):
 *         i = order[_i]             # <<<<<<<<<<<<<<
 *         if suppressed[i] == 1:
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":100
 *     for _i in range(ndets):
 *         i = order[_i]
 *         if suppressed[i] == 1:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_20) {
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":101
 *         i = order[_i]
 *         if suppressed[i] == 1:
 *             continue             # <<<<<<<<<<<<<<
 *         keep.append(i)
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":102
 *         if suppressed[i] == 1:
 *             continue
 *         keep.append(i)             # <<<<<<<<<<<<<<
 *         ix1 = x1[i]
 *         iy1 = y1[i]
 */
    __pyx_t_12 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_21 = __Pyx_PyList_Append(__pyx_v_keep, __pyx_t_12); if (unlikely(__pyx_t_21 == ((int)-1))) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;

    /* "ctpn/lib/utils/cython_nms.pyx":103
 *             continue
 *         keep.append(i)
 *         ix1 = x1[i]             # <<<<<<<<<<<<<<
 *         iy1 = y1[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":104
 *         keep.append(i)
 *         ix1 = x1[i]
 *         iy1 = y1[i]             # <<<<<<<<<<<<<<
 *         ix2 = x2[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":105
 *         ix1 = x1[i]
 *         iy1 = y1[i]
 *         ix2 = x2[i]             # <<<<<<<<<<<<<<
 *         iy2 = y2[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":106
 *         iy1 = y1[i]
 *         ix2 = x2[i]
 *         iy2 = y2[i]             # <<<<<<<<<<<<<<
 *         iarea = areas[i]
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":107
 *         ix2 = x2[i]
 *         iy2 = y2[i]
 *         iarea = areas[i]             # <<<<<<<<<<<<<<
 *         for _j in range(_i + 1, ndets):
 ...
 */
    ...
    /* "ctpn/lib/utils/cython_nms.pyx":108
 *         iy2 = y2[i]
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):             # <<<<<<<<<<<<<<
 *             j = order[_j]
 ...
 */
    ...
    for (__pyx_t_28 = (__pyx_v__i + 1); __pyx_t_28 < __pyx_t_27; __pyx_t_28+=1) {
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":109
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]             # <<<<<<<<<<<<<<
 *             if suppressed[j] == 1:
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":110
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]
 *             if suppressed[j] == 1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_20) {
        ...
        /* "ctpn/lib/utils/cython_nms.pyx":111
 *             j = order[_j]
 *             if suppressed[j] == 1:
 *                 continue             # <<<<<<<<<<<<<<
 *             xx1 = max(ix1, x1[j])
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":112
 *             if suppressed[j] == 1:
 *                 continue
 *             xx1 = max(ix1, x1[j])             # <<<<<<<<<<<<<<
 *             yy1 = max(iy1, y1[j])
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":113
 *                 continue
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])             # <<<<<<<<<<<<<<
 *             xx2 = min(ix2, x2[j])
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":114
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])             # <<<<<<<<<<<<<<
 *             yy2 = min(iy2, y2[j])
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":115
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])             # <<<<<<<<<<<<<<
 *             w = max(0.0, xx2 - xx1 + 1)
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":116
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)             # <<<<<<<<<<<<<<
 *             h = max(0.0, yy2 - yy1 + 1)
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":117
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)             # <<<<<<<<<<<<<<
 *             inter = w * h
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":118
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h             # <<<<<<<<<<<<<<
 *             ovr = inter / (iarea + areas[j] - inter)
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":119
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)             # <<<<<<<<<<<<<<
 *             ovr1 = inter / iarea
 ...
 */
      ...
      /* "ctpn/lib/utils/cython_nms.pyx":120
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)
 *             ovr1 = inter / iarea             # <<<<<<<<<<<<<<
 *             ovr2 = inter / areas[j]
 ...
 */
      ...
      __pyx_t_12 = PyFloat_FromDouble((__pyx_v_inter / __pyx_v_iarea)); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 120, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __Pyx_XDECREF_SET(__pyx_v_ovr1, __pyx_t_12);
      __pyx_t_12 = 0;

      /* "ctpn/lib/utils/cython_nms.pyx":121
 *             ovr = inter / (iarea + areas[j] - inter)
 *             ovr1 = inter / iarea
 *             ovr2 = inter / areas[j]             # <<<<<<<<<<<<<<
 *             if ovr >= thresh or ovr1 > 0.95 or ovr2 > 0.95:
 ...
 */
      ...
      __pyx_t_12 = PyFloat_FromDouble((__pyx_v_inter / __pyx_t_37)); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 121, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __Pyx_XDECREF_SET(__pyx_v_ovr2, __pyx_t_12);
      __pyx_t_12 = 0;

      /* "ctpn/lib/utils/cython_nms.pyx":122
 *             ovr1 = inter / iarea
 *             ovr2 = inter / areas[j]
 *             if ovr >= thresh or ovr1 > 0.95 or ovr2 > 0.95:             # <<<<<<<<<<<<<<
 *                 suppressed[j] = 1
 * 
 */
      __pyx_t_12 = PyFloat_FromDouble(__pyx_v_ovr); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 122, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __pyx_t_8 = PyObject_RichCompare(__pyx_t_12, __pyx_v_thresh, Py_GE); __Pyx_XGOTREF(__pyx_t_8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 122, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_39 = __Pyx_PyObject_IsTrue(__pyx_t_8); if (unlikely(__pyx_t_39 < 0)) __PYX_ERR(0, 122, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      if (!__pyx_t_39) {
      } else {
      ...
      __pyx_t_8 = PyObject_RichCompare(__pyx_v_ovr1, __pyx_float_0_95, Py_GT); __Pyx_XGOTREF(__pyx_t_8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 122, __pyx_L1_error)
      __pyx_t_39 = __Pyx_PyObject_IsTrue(__pyx_t_8); if (unlikely(__pyx_t_39 < 0)) __PYX_ERR(0, 122, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      if (!__pyx_t_39) {
      } else {
      ...
      __pyx_t_8 = PyObject_RichCompare(__pyx_v_ovr2, __pyx_float_0_95, Py_GT); __Pyx_XGOTREF(__pyx_t_8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 122, __pyx_L1_error)
      __pyx_t_39 = __Pyx_PyObject_IsTrue(__pyx_t_8); if (unlikely(__pyx_t_39 < 0)) __PYX_ERR(0, 122, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_20 = __pyx_t_39;
      ...
      if (__pyx_t_20) {
        ...
        /* "ctpn/lib/utils/cython_nms.pyx":123
 *             ovr2 = inter / areas[j]
 *             if ovr >= thresh or ovr1 > 0.95 or ovr2 > 0.95:
 *                 suppressed[j] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":125
 *                 suppressed[j] = 1
 * 
 *     return keep             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_ctpn_lib_utils_cython_nms, __pyx_k_ctpn_lib_utils_cython_nms, sizeof(__pyx_k_ctpn_lib_utils_cython_nms), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_slice_, __pyx_int_0); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 20, __pyx_L1_error)
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 */
  __pyx_tuple__3 = PyTuple_Pack(2, __pyx_slice_, __pyx_int_1); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 */
  __pyx_tuple__4 = PyTuple_Pack(2, __pyx_slice_, __pyx_int_2); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 22, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__5 = PyTuple_Pack(2, __pyx_slice_, __pyx_int_3); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 23, __pyx_L1_error)
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 */
  __pyx_tuple__6 = PyTuple_Pack(2, __pyx_slice_, __pyx_int_4); if (unlikely(!__pyx_tuple__6)) __PYX_ERR(0, 24, __pyx_L1_error)
 ...
 *     cdef int ndets = dets.shape[0]
 */
  __pyx_slice__7 = PySlice_New(Py_None, Py_None, __pyx_int_neg_1); if (unlikely(!__pyx_slice__7)) __PYX_ERR(0, 27, __pyx_L1_error)
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_tuple__17 = PyTuple_Pack(31, __pyx_n_s_dets, __pyx_n_s_thresh, __pyx_n_s_x1, __pyx_n_s_y1, __pyx_n_s_x2, __pyx_n_s_y2, __pyx_n_s_scores, __pyx_n_s_areas, __pyx_n_s_order, __pyx_n_s_ndets, __pyx_n_s_suppressed, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_i_2, __pyx_n_s_j_2, __pyx_n_s_ix1, __pyx_n_s_iy1, __pyx_n_s_ix2, __pyx_n_s_iy2, __pyx_n_s_iarea, __pyx_n_s_xx1, __pyx_n_s_yy1, __pyx_n_s_xx2, __pyx_n_s_yy2, __pyx_n_s_w, __pyx_n_s_h, __pyx_n_s_inter, __pyx_n_s_ovr, __pyx_n_s_keep, __pyx_n_s_ovr1, __pyx_n_s_ovr2); if (unlikely(!__pyx_tuple__17)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__17);
  __Pyx_GIVEREF(__pyx_tuple__17);
  __pyx_codeobj__18 = (PyObject*)__Pyx_PyCode_New(2, 0, 31, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__17, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_nms_pyx, __pyx_n_s_nms_new, 72, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__18)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_ctpn__lib__utils__cython_nms) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ctpn.lib.utils.cython_nms")) {
      if (unlikely(PyDict_SetItemString(modules, "ctpn.lib.utils.cython_nms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "ctpn/lib/utils/cython_nms.pyx":8
 * # --------------------------------------------------------
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4ctpn_3lib_5utils_10cython_nms_1nms, NULL, __pyx_n_s_ctpn_lib_utils_cython_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_nms, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4ctpn_3lib_5utils_10cython_nms_3nms_new, NULL, __pyx_n_s_ctpn_lib_utils_cython_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_nms_new, __pyx_t_1) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "ctpn/lib/utils/cython_nms.pyx":1
 * # --------------------------------------------------------             # <<<<<<<<<<<<<<
 * # Fast R-CNN
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ctpn.lib.utils.cython_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ctpn.lib.utils.cython_nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
