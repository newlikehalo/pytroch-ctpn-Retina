...
from retina_fpnnew import RetinaFPN101
import numpy as np
import ipdb
...
class CTPN_Model(nn.Module):
    def __init__(self):
        ...
        # self.newbrnn = BLSTM(256, 128, bidirectional=True)
        self.brnn = nn.LSTM(256, 128, bidirectional=True, batch_first=True)

        self.lstm_fc = BasicConv(512, 256, 1, 1, relu=True, bn=False)
        self.rpn_class = BasicConv(256, 10 * 2, 1, 1, relu=False, bn=False)
        self.rpn_regress = BasicConv(256, 10 * 2, 1, 1, relu=False, bn=False)
